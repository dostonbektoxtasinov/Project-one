        ...
        <div class="contact-form">
            ...
            <form action="{{ route('about.update',  ['about' => $about->id]) }}" method="POST">
                ...
                <div class="control-group mb-4">
                    ...
                    <input type="text" class="form-control p-4" name="name" value="{{ $about->name }}" placeholder="Sheriklar" value="{{ old('name') }}"/>
                    @error('Sheriklar')
                ...
                <div class="control-group mb-4">
                    ...
                    <input type="number" class="form-control p-4" name="number" value="{{ $about->number }}" placeholder="Ular qancha" value="{{ old('number') }}"/>
                    @error('Nomer')
                        <p class="help-block text-danger mt-4">{{ $message }}</p>
                    @enderror
                </div>
